module.exports = {
    ...
    // To change specific things about specific gamemodes (such as team count for tdm), edit their config file in \modules\setup\gamemodeconfigs\. GAME_MODES: ['tdm', 'domination', 'growth'],
    GAME_MODES: ['tdm', 'domination', 'growth'],
    ...
    // NOTE: These prefixes are only for categorisation, a room file would work the same regardless of its prefix. APS++ does nothing based on file name prefixes. ROOM_SETUP: ['map_apspp_default'],
    ...
    BOT_SKILL_UPGRADE_CHANCES: [ 1, 1, 3, 10, 10, 10, 10, 2, 1, 1],
    ...
    FOOD_SPAWN_CHANCE: 10.000, // Likeliness of normal food spawn attempts succeedingg.
    ...
    FOOD_SPAWN_CHANCE_NEST: 0.0, // Likeliness of nest food spawn attempts succeeding.
    ...
    BOSS_SPAWN_COOLDOWN: 2200000000,
    ...
    FOOD_TYPES: [
        [20, [
            [512, 'fallenegg'], [256, 'fallensquare'], [128, 'fallentriangle'], [64, 'fallenpentagon'], [32, 'fallenhexagon'], [16, 'fallenbosshexagon']
        ]],
        /*[10, [
        ...
        [0.05, [
            [6561, 'transSquare'], [729, 'transTriangle'], [81, 'transPentagon'], [9, 'transBetaPentagon'], [1, 'transAlphaPentagon']
        ]],
        [1000.01, [
            [100000, 'sphere'], [100000, 'cube'], [100000, 'tetrahedron'], [100000, 'octahedron'], [100000, 'dodecahedron'], [100000, 'icosahedron']
        ]]*/
    ],
    ...
    BOSS_TYPES: [{
        bosses: ["peacemaker"],
        amount: [3], chance: 2, nameType: "a",
		message: "International troops are intervening to end the war!",
    }],
