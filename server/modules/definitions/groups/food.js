...
exports.fallenegg = {
    ...
    BODY: {
        FOV: 0.5,
        ACCELERATION: 0.75,
        DAMAGE: 5.0 * base.DAMAGE,
        SPEED: 1.00 * base.SPEED,
        HEALTH: 0.003 * base.HEALTH,
    },
    MOTION_TYPE: "motor",
...
exports.fallentriangle = {
    ...
    BODY: {
        ...
        ACCELERATION: 0.75,
        DAMAGE: 5.0 * base.DAMAGE,
        SPEED: 0.60 * base.SPEED,
        HEALTH: 0.15 * base.HEALTH,
    },
    MOTION_TYPE: "motor",
    FACING_TYPE: "smoothToTarget",
    HITS_OWN_TYPE: "never",
	...
	GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                MAX_CHILDREN: 1,
				SHOOT_SETTINGS: combineStats([g.fallenfood, g.halfreload, g.halfreload]),
                TYPE: "fallenegg",
            },
        },
        {
...
exports.fallenpentagon = {
    ...
    BODY: {
        FOV: 0.5,
        ACCELERATION: 0.75,
        DAMAGE: 2.0 * base.DAMAGE,
        SPEED: 0.50 * base.SPEED,
        HEALTH: 2.0 * base.HEALTH,
    },
    MOTION_TYPE: "motor",
    FACING_TYPE: "smoothToTarget",
    HITS_OWN_TYPE: "never",
	...
	GUNS: [
		{
			...
			PROPERTIES: {
                MAX_CHILDREN: 1,
				SHOOT_SETTINGS: combineStats([g.basic, g.healthtwin, g.healthtwin]),
                TYPE: "bullet",
            },
        },
        {
            POSITION: [5, 4, 1, 10.5, 0, 180, 0],
        },
        {
            POSITION: [3, 6, 1, 15.5, 0, 180, 0],
        },
        {
            POSITION: [2, 6, 1.3, 18, 0, 180, 0],
            PROPERTIES: {
                MAX_CHILDREN: 2,
				SHOOT_SETTINGS: combineStats([g.fallenfood, g.halfreload, g.halfreload]),
                TYPE: "fallenegg",
        ...
        },
		{
            ...
            PROPERTIES: {
                MAX_CHILDREN: 1,
				SHOOT_SETTINGS: combineStats([g.fallenfood, g.halfreload, g.halfreload, g.halfreload]),
                TYPE: "fallensquare",
            },
        },
        {
            POSITION: [4, 6, 1, 8, 0, 180, 0],
        },
    ],
};
exports.fallenbosshexagon = {
    PARENT: ["genericTank"],
    DANGER: 6,
    SHAPE: 6,
    SIZE: 22,
    ...
    BODY: {
        ...
        ACCELERATION: 0.75,
        DAMAGE: 2.0 * base.DAMAGE,
        SPEED: 0.30 * base.SPEED,
        HEALTH: 15.0 * base.HEALTH,
    },
    MOTION_TYPE: "motor",
    FACING_TYPE: "smoothToTarget",
    HITS_OWN_TYPE: "never",
