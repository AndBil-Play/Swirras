...
exports.peacemaker = {
  ...
  BODY: {
        HEALTH: base.HEALTH * 0.10,
    },
  GUNS: [
    {
            POSITION: [12, 10, 1.4, 8, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.mach, g.damagex2, g.damagex2, g.healthx2]),
                TYPE: "bullet",
        },
    },
	{
    ...
    {
      POSITION: [2, 10, 1, 15.5, 0, -30, 0],
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([g.factory, g.damagex2]),
        TYPE: "minion",
        STAT_CALCULATOR: gunCalcNames.drone,
        AUTOFIRE: true,
        SYNCS_SKILLS: true,
    ...
    {
      /**** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
      POSITION: [5, 8, 1, 10.5, 0, 150, 0],
    },
    {
      /**** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
      POSITION: [5, 8, 1, 10.5, 0, 210, 0],
    },
    {
      /**** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
    ...
    {
      POSITION: [2, 10, 1, 15.5, 0, 210, 0.5],
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([g.factory, g.damagex2]),
        TYPE: "minion",
        STAT_CALCULATOR: gunCalcNames.drone,
    ...
    {
      POSITION: [2, 10, 1, 15.5, 0, 180, 0.5],
      PROPERTIES: {
        SHOOT_SETTINGS: combineStats([g.factory, g.damagex2]),
        TYPE: "minion",
        STAT_CALCULATOR: gunCalcNames.drone,
    ...
    {
      POSITION: [4, 10, 1, 8, 0, 150, 0],
    },
    {
      POSITION: [4, 10, 1, 8, 0, 210, 0],
    },
    {
      POSITION: [4, 10, 1, 8, 0, 180, 0],
    },
  ],
  TURRETS: [
  {
