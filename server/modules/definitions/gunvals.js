module.exports = {
    // Misc
    blank: { },
	minion5: [600, 1, 0.1, 0.7, 1, 0.75, 1, 3, 1, 1, 1, 0.1, 1],
    small: { size: 0.8 },
    micro: { size: 0.4 },
    ...
    fake: { recoil: 0.00001, health: 0.0001, damage: 0.0001, maxSpeed: 1.5 },
	realfake: { recoil: 0.00001, size: 0.00001, health: 0.0001, speed: 0.00001, maxSpeed: 2, range: 0 },
    op: { reload: 0.5, recoil: 1.3, health: 4, damage: 4, pen: 4, speed: 3, maxSpeed: 2, density: 5, spray: 2 },
    closer: { reload: 1.25, recoil: 0.25, health: 10, damage: 10, pen: 10, speed: 2.5, maxSpeed: 2.25, range: 1.4, density: 4, spray: 0.25 },
	lancer: { reload: 0.4, damage: 1.75, speed: 0.1, maxSpeed: 0.1, range: 0.1, recoil: 0.001 },
	lancerdebuff: { reload: 1.1, damage: 0.90, pen: 0.01, density: 0.01, speed: 0.6, maxSpeed: 0.6, spray: 2.0 },
	damagetwin: { damage: 0.5 },
	damagex15: { damage: 1.5 },
	damagex2: { damage: 2 },
	healthx2: { health: 2 },
	healthtwin: { health: 0.5 },
	damagetriple: { damage: 0.33 },
	damage75: { damage: 0.75 },
	damageweak: { damage: 1.10 },
	damageweakweak: { damage: 0.90 },
	not1d2recoil: { recoil: 0.5 },
	infinity: { reload: 8 },
	finity: { reload: 0.25 },
	laser: { damage: 0.8, reload: 0.15, recoil: 0.01, shudder: 0.01, spray: 0.01, pen: 0.01, range: 0.12, speed: 2.2, maxSpeed: 2.2 },
	lanser: { damage: 1.6, range: 0.65, speed: 0.8, maxSpeed: 0.8, size: 2.0 },
	laserspeed: { damage: 0.9, range: 1.3, speed: 1.2, maxSpeed: 1.2 },
	pawn: { shudder: 0.25, damage: 1.75, spray: 0.10, pen: 0.10, speed: 0.60, maxSpeed: 0.60 },
	fakedebuff: { damage: 0.90 },
	streamlineddebuff: { damage: 0.80 },
	overstreamlined: { reload: 0.15, damage: 0.01, recoil: 0.75, spray: 2.50, range: 0.10, speed: 0.60, maxSpeed: 0.60 },
	overstream: { recoil: 0.75 },
	flamethrower: { reload: 0.20, recoil: 0.4, damage: 0.075, health: 6, shudder: 2.0, speed: 0.5, maxSpeed: 0.5, range: 1.3, spray: 2.50 },
	hazeflamethrower: { reload: 0.40, recoil: 0.01, size: 0.6, health: 0.5, damage: 1.80, speed: 0.40, shudder: 3.0, spray: 4.00 },
	brokensniper: { reload: 2.30, recoil: 0.01, size: 0.6, health: 0.5, damage: 3.50, speed: 1.4, maxSpeed: 1.4 },
	alphaex: { reload: 2.10, speed: 0.50, maxSpeed: 0.50, range: 1.50 },

    // Bases
    basic: { reload: 18, recoil: 1.4, shudder: 0.1, damage: 0.75, speed: 5.5, spray: 15 },
	newbasic: { damage: 1.10 },
    drone: { reload: 50, recoil: 0.25, shudder: 0.1, size: 0.6, speed: 3.0, spray: 0.1 },
    trap: { reload: 36, shudder: 0.25, size: 0.6, damage: 0.75, speed: 6.5, spray: 15, resist: 3 },
	virus: { reload: 20, shudder: 0.20, size: 0.6, damage: 3.0, health: 0.250, speed: 3, spray: 5, resist: 2 },
    swarm: { reload: 18, recoil: 0.25, shudder: 0.05, size: 0.4, damage: 0.80, speed: 6, spray: 5 },
    factory: { reload: 60, shudder: 0.1, size: 0.7, damage: 0.75, speed: 4, spray: 0.1 },
	bigfactory: { reload: 120, shudder: 0.1, size: 0.7, damage: 0.75, speed: 4, spray: 0.1 },
	bigbigfactory: { reload: 300, shudder: 0.1, size: 0.7, damage: 0.75, speed: 4, spray: 0.1 },
	nonfactory: { reload: 500, size: 2.0, shudder: 0.1, size: 0.7, damage: 0.75, speed: 4, spray: 0.1 },
	general: { reload: 100, shudder: 0.1, size: 0.7, damage: 0.75, speed: 4, spray: 0.1 },
    productionist: { reload: 75, recoil: 0.25, shudder: 0.05, size: 0.7, damage: 0.75, speed: 5, range: 1.5, spray: 5 },
	desmos: { shudder: 0.0001, spray: 0.0001, size: 0.8, damage: 1.05 },
	money: { reload: 22, recoil: 0.5, shudder: 0.05, damage: 0.35, speed: 5.0, spray: 5 },
	fallenfood: { reload: 18, health: 0.12, damage: 0.12 },

    // Spammers
    single: { reload: 0.95, speed: 1.05 },
    ...
    // Machine guns
    mach: { reload: 0.5, recoil: 0.8, shudder: 1.7, health: 0.75, damage: 0.7, maxSpeed: 0.8, spray: 2.5 },
	overmach: { size: 0.8, reload: 0.5, recoil: 0.6, shudder: 1.1, health: 0.75, damage: 0.7, maxSpeed: 0.9, spray: 1.1 },
	machtrapper: { size: 0.5, reload: 0.37, recoil: 0.7, shudder: 1.5, health: 0.45, damage: 1.0, speed: 0.8, maxSpeed: 0.8, spray: 1.5 },
	machbuilter: { size: 0.75, reload: 0.5, recoil: 0.8, health: 0.4, damage: 1.0 },
    ...
    nail: { reload: 0.7, recoil: 2.5, size: 0.8, damage: 0.7, density: 2, speed: 1.1, maxSpeed: 1.1 },
    ...
    gunnerDominator: { reload: 1.1, recoil: 0, shudder: 1.1, size: 0.5, health: 1.0, damage: 1.0, speed: 1.1, density: 0.9, spray: 1.2, resist: 0.8 },
	bigmoney: { reload: 2.0, recoil: 0.75, shudder: 1.15, size: 1.2, health: 2.20, damage: 1.50, speed: 0.70, maxSpeed: 0.60, density: 1.25, spray: 1.25 },
    ...
    // Drones
    over: { reload: 1.25, size: 0.85, health: 0.8, damage: 0.9, maxSpeed: 0.9, density: 2 },
    meta: { reload: 1.333, damage: 0.667 },
    overdrive: { reload: 5, health: 1.2, damage: 0.6, pen: 0.8, speed: 0.9, maxSpeed: 0.9, range: 0.9, spray: 1.2 },
	drive: { reload: 2, health: 1.1, damage: 0.6, pen: 0.8, speed: 0.75, maxSpeed: 0.75, range: 0.9, spray: 1.2 },
    ...
    carrier: { reload: 1.2, damage: 0.75, speed: 1.1, maxSpeed: 1.1, range: 1.2 },
    bees: { reload: 1.3, size: 1.4, damage: 0.6, pen: 0.5, speed: 2.00, maxSpeed: 1.50, density: 0.25 },
	controllablebee: { reload: 1.2, damage: 0.9, size: 1.2, speed: 0.60, maxSpeed: 0.65, pen: 1.5 },
    ...
    minion: { shudder: 2, health: 0.5, damage: 0.4, pen: 1.2, range: 0.75, spray: 2 },
	minionx1i5: { shudder: 2, health: 0.75, damage: 0.6, pen: 1.2, range: 0.75, spray: 2 },
    babyfactory: { reload: 1.5, maxSpeed: 1.35 },
    mehdrone: { size: 1.35, health: 1.75, speed: 1.125 },
    bigdrone: { size: 1.8, health: 5.5, damage: 1.4, speed: 0.70 },
	greatdrone: { size: 2.0, health: 7.0, damage: 1.5, speed: 0.60 },
	minibigdrone: { size: 1.4, health: 2.00, damage: 1.4, speed: 0.70 },
    mothership: { reload: 1.25, pen: 1.1, speed: 0.775, maxSpeed: 0.8, range: 15, resist: 1.15 },
	haze: { reload: 1.2, size: 1.75, health: 2.5, damage: 3.5, speed: 0.55 },
	hazemini: { reload: 0.70, size: 2.0, health: 0.5, damage: 1.80, speed: 0.60 },
	storm: { reload: 1.20, size: 1.5, health: 1.75, damage: 4.0, speed: 0.80, maxSpeed: 0.80, range: 1.5, density: 2 },
	hastedrone: { reload: 0.80, health: 0.80, speed: 1.4, maxSpeed: 1.20 },
	satellite: { size: 0.8, reload: 3, damage: 3.5 },
	fallennecro: { reload: 0.25, damage: 1.75, speed: 1.30, maxSpeed: 1.30 },
	...
	strongi: {  reload: 2.5, health: 2, damage: 1.0, speed: 0.75, maxSpeed: 0.75, recoil: 1.5, size: 0.75, range: 2.0 },
	drunk: {  reload: 1.1, size: 0.75, range: 2.0 },
	brew: {  damage: 0.35, health: 0.8, recoil: 0.35 },
    ...
    construct: { reload: 1.3, size: 0.9, health: 1.3, maxSpeed: 0.8 },
    boomerang: { reload: 0.8, health: 0.8, damage: 0.8, speed: 0.75, maxSpeed: 0.75, range: 1.333 },
	...
	trapperSmallDominator: { reload: 4.00, recoil: 0, shudder: 0.25, health: 3.00, damage: 1.00, pen: 1.6, speed: 0.4, maxSpeed: 1.5, range: 0.7, spray: 0.5 },
	...
	one_third_morereload: { reload: 0.666 },
