...
function collide(collision) {
    ...
    switch (true) {
        case instance.type === "wall" || other.type === "wall":
			...
			if (instance.type === "haze" || other.type === "haze") return;
        ...
        case instance.team !== other.team ||
            ...
            } else if (instance.type === "haze") {
                if (!(other.type === "tank" || other.type === "miniboss" || other.type == "food")) return;
            } else if (other.type === "haze") {
                if (!(instance.type === "tank" || instance.type === "miniboss" || instance.type == "food")) return;
            } else if (other.type === "chain") {
                if (!(instance.type == "food")) return;
            } else if (instance.type === "chain") {
                if (!(other.type == "food")) return;
            }
        ...
        case instance.settings.hitsOwnType === other.settings.hitsOwnType:
            switch (instance.settings.hitsOwnType) {
                case 'assembler': {
                    ...
                    target1.SPEED = better('SPEED') * 0.8;
                    target1.HEALTH = better('HEALTH') * 1.4;
                    target1.health.amount = target1.health.max;
                    target1.DAMAGE = better('DAMAGE') * 1.2;
                    target2.kill();
                ...
                case "hardOnlyTanks":
                    if (
                        ...
                        firmcollide(instance, other);
				case "hardOnlyBulletSmasher":
                    if (
                        instance.type === "bulletsmasher" &&
                        other.type === "bulletsmasher" //&&
                        //!instance.isDominator &&
                        //!other.isDominator
                    )
                        firmcollide(instance, other);
